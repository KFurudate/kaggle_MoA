...
### The main idea of my solution
  ...
  - Performed pseudo label(semi-supervised learning) with reference to the target variable distribution in train data (some may not be randomly divided, so I hope to predict this well and rank up!).
